...
public class Exercise3 {
	...
	public static void main(String[] args) {
		...
		PCollectionTuple results = p.apply(TextIO.Read.from("/Users/laraschmidt/Documents/package_log.txt"))
		...
		})).apply(TextIO.Write.named("WriteMyFile").to("/Users/laraschmidt/Documents/package_out.txt"));

		results.get(extraLines)
				.apply(TextIO.Write.named("WriteMyFile").to("/Users/laraschmidt/Documents/package_bad_lines.txt"));
		p.run();
	}
}
